...
export const Paciente = ({ paciente, setPaciente, eliminarPaciente }) => {
 // console.log(paciente)
  ...
  const { nombre, acompanante, email, fecha, notas, id } = paciente
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
      ...
      <p className="font-bold mb-3 text-gray-700 uppercase">Acompanante: {''}
        <span className="font-normal normal-case">{acompanante}</span>
      </p>
